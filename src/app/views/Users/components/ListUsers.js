            ...
            <div className="container" id="container">
                ...
                <Panel header="LISTA DE USUARIOS" style={{ textAlign: "center" }}>
                    <DataTable paginator rows={10} dataKey="id" filters={filters}
                        globalFilterFields={['username', 'persona.cedula'/* , 'persona.nombre', 'persona.apellido', 'rol.rolNombre', 'enabled' */]} filterDisplay="row"
                        header={header} emptyMessage="Ningun Usuario Encontrado" value={users}
                        selectionMode="single" rowsPerPageOptions={[5, 10, 25, 50]} responsiveLayout="scroll"
                        style={{ textAlign: "center" }}
                        onSelectionChange={(e) => saveUser(e.value.username)}>

                        <Column field="username" header="Nombre de Usuario" filterField="users.username" />
