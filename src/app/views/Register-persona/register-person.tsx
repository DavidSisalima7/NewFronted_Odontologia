...
export default function RegisterPerson() {
    ...
    const { cedula, nombre, apellido, email, fecha_nacimiento, genero, celular, direccion, telefono } = person;
    ...
    const formikPerson = useFormik<Persona>({
        ...
        // validaciones
        validate: (data: { cedula: string; nombre: string; apellido: string; email: string; fecha_nacimiento: string; genero: string; celular: string; direccion: string; telefono: string }) => {
                    ...
                    <form onSubmit={(e) => onSubmit(e)} className="p-fluid" style={{ marginTop: 20 }}>
                        <div className="row">
                            ...
                            <div className="col">
                                ...
                                <div className="campo p-col-12 p-md-4">
                                    <span className="p-float-label">
                                        <InputText type={"date"} id="float-input" name="fecha_nacimiento" value={fecha_nacimiento} onChange={(e) => onInputChange(e)}
                                            className={classNames("inputBox", { "p-invalid": isFormFieldValidP("fecha_nacimiento"), })} />
                                        <label htmlFor="name" className={classNames({ "p-error": isFormFieldValidP("fecha_nacimiento"), })}>
                                            Fecha de Nacimiento
                                        </label>
                                    </span>
                                    {getFormErrorMessageP("fecha_nacimiento")}
                                </div>
